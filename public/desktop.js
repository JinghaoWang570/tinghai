...
function clapperVoiceSelection(){if(state.style==='clapper')return '<div class="setting clapper-voice"><label>快板音色 · 明快利落</label><p class="micro">固定演员音色，每期保持一致</p><audio controls preload="none" src="/audio/voices/clapper-fixed-v1.mp3" style="width:100%"></audio></div>';return `<div class="setting clapper-voice"><label for="performance-description">声音与表演描述</label><textarea id="performance-description" maxlength="240" rows="3" placeholder="描述声音、语气与表演方式">${esc(performanceDescription())}</textarea><p class="micro">用文字定义这期节目的讲述方式</p></div>`}
